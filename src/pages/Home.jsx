...
const Home = () => {
  ...
  <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-6">
    ...
    <a
      href="/pet-listing"
      className="mt-6 bg-yellow-400 text-black px-6 py-3 md:px-10 md:py-4 rounded-full font-semibold text-lg shadow-lg hover:bg-yellow-500 transition-transform transform hover:scale-105"
    >
      Start Your Journey
    </a>
  </div>
